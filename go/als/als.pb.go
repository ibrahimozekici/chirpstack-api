...
type CreateColdRoomRestrictionsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ColdResResp *ColdRoomRestrictions `protobuf:"bytes,1,opt,name=coldResResp,proto3" json:"coldResResp,omitempty"`
}

func (x *CreateColdRoomRestrictionsResponse) Reset() {
	*x = CreateColdRoomRestrictionsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateColdRoomRestrictionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateColdRoomRestrictionsResponse) ProtoMessage() {}

func (x *CreateColdRoomRestrictionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_als_als_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateColdRoomRestrictionsResponse.ProtoReflect.Descriptor instead.
func (*CreateColdRoomRestrictionsResponse) Descriptor() ([]byte, []int) {
	return file_als_als_proto_rawDescGZIP(), []int{7}
}

func (x *CreateColdRoomRestrictionsResponse) GetColdResResp() *ColdRoomRestrictions {
	if x != nil {
		return x.ColdResResp
	}
	return nil
}
...
var file_als_als_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x45, 0x0a, 0x15, 0x69, 0x6f, 0x2e, 0x63, 0x68, 0x69, 0x72,
...
var file_als_als_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_als_als_proto_goTypes = []interface{}{
	...
	(*CreateColdRoomRestrictionsResponse)(nil), // 7: als.CreateColdRoomRestrictionsResponse
}
var file_als_als_proto_depIdxs = []int32{
	...
	1, // 4: als.CreateColdRoomRestrictionsResponse.coldResResp:type_name -> als.ColdRoomRestrictions
	...
	6, // 7: als.AlarmServerService.CreateColdRoomRestrictions:input_type -> als.CreateColdRoomRestrictionsRequest
	3, // 8: als.AlarmServerService.CreateAlarm:output_type -> als.CreateAlarmResponse
	5, // 9: als.AlarmServerService.GetAlarm:output_type -> als.GetAlarmResponse
	7, // 10: als.AlarmServerService.CreateColdRoomRestrictions:output_type -> als.CreateColdRoomRestrictionsResponse
...
func file_als_als_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_als_als_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateColdRoomRestrictionsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type AlarmServerServiceClient interface {
	...
	CreateColdRoomRestrictions(ctx context.Context, in *CreateColdRoomRestrictionsRequest, opts ...grpc.CallOption) (*CreateColdRoomRestrictionsResponse, error)
}
...
func (c *alarmServerServiceClient) CreateColdRoomRestrictions(ctx context.Context, in *CreateColdRoomRestrictionsRequest, opts ...grpc.CallOption) (*CreateColdRoomRestrictionsResponse, error) {
	out := new(CreateColdRoomRestrictionsResponse)
...
type AlarmServerServiceServer interface {
	...
	// rpc CreateAlarmDates(CreateAlarmDateRequest) returns (CreateAlarmDateResponse){}
	// rpc GetAlarmLogs(GetAlarmLogRequest) returns (GetAlarmLogResponse){}
	CreateColdRoomRestrictions(context.Context, *CreateColdRoomRestrictionsRequest) (*CreateColdRoomRestrictionsResponse, error)
}
...
func (*UnimplementedAlarmServerServiceServer) CreateColdRoomRestrictions(context.Context, *CreateColdRoomRestrictionsRequest) (*CreateColdRoomRestrictionsResponse, error) {
