...
var (
	filter_AlarmService_List_0 = &utilities.DoubleArray{Encoding: map[string]int{"dev_eui": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func RegisterAlarmServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AlarmServiceServer) error {
	...
	mux.Handle("DELETE", pattern_AlarmService_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
...
var (
	...
	pattern_AlarmService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "alarm", "dev_eui"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_AlarmService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "devices", "alarm_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
