...
var file_as_external_api_organization_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_as_external_api_organization_proto_goTypes = []interface{}{
	...
	(*OrganizationExistRequest)(nil),      // 19: api.OrganizationExistRequest
	(*OrganizationExistResponse)(nil),     // 20: api.OrganizationExistResponse
...
var file_as_external_api_organization_proto_depIdxs = []int32{
	21, // 0: api.OrganizationListItem.created_at:type_name -> google.protobuf.Timestamp
	21, // 1: api.OrganizationListItem.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 2: api.GetOrganizationResponse.organization:type_name -> api.Organization
	21, // 3: api.GetOrganizationResponse.created_at:type_name -> google.protobuf.Timestamp
	21, // 4: api.GetOrganizationResponse.updated_at:type_name -> google.protobuf.Timestamp
	...
	21, // 8: api.OrganizationUserListItem.created_at:type_name -> google.protobuf.Timestamp
	21, // 9: api.OrganizationUserListItem.updated_at:type_name -> google.protobuf.Timestamp
	...
	21, // 14: api.GetOrganizationUserResponse.created_at:type_name -> google.protobuf.Timestamp
	21, // 15: api.GetOrganizationUserResponse.updated_at:type_name -> google.protobuf.Timestamp
	...
	19, // 26: api.OrganizationService.OrganizationExist:input_type -> api.OrganizationExistRequest
	9,  // 27: api.OrganizationService.List:output_type -> api.ListOrganizationResponse
	3,  // 28: api.OrganizationService.Get:output_type -> api.GetOrganizationResponse
	5,  // 29: api.OrganizationService.Create:output_type -> api.CreateOrganizationResponse
	22, // 30: api.OrganizationService.Update:output_type -> google.protobuf.Empty
	22, // 31: api.OrganizationService.Delete:output_type -> google.protobuf.Empty
	16, // 32: api.OrganizationService.ListUsers:output_type -> api.ListOrganizationUsersResponse
	18, // 33: api.OrganizationService.GetUser:output_type -> api.GetOrganizationUserResponse
	22, // 34: api.OrganizationService.AddUser:output_type -> google.protobuf.Empty
	22, // 35: api.OrganizationService.UpdateUser:output_type -> google.protobuf.Empty
	22, // 36: api.OrganizationService.DeleteUser:output_type -> google.protobuf.Empty
	20, // 37: api.OrganizationService.OrganizationExist:output_type -> api.OrganizationExistResponse
