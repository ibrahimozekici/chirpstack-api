...
var file_as_external_api_alarm_proto_rawDesc = []byte{
	...
	0x49, 0x44, 0x32, 0xea, 0x02, 0x0a, 0x0c, 0x41, 0x6c, 0x61, 0x72, 0x6d, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x50, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x17, 0x2e,
	...
	0x72, 0x6d, 0x3a, 0x01, 0x2a, 0x12, 0x50, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x14, 0x2e, 0x61,
	...
	0x16, 0x12, 0x14, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x6c, 0x61, 0x72, 0x6d, 0x2f, 0x7b, 0x64,
	0x65, 0x76, 0x5f, 0x65, 0x75, 0x69, 0x7d, 0x12, 0x5a, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x19, 0x2a, 0x17, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x64, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2f, 0x7b, 0x61, 0x6c, 0x61, 0x72, 0x6d, 0x5f, 0x69, 0x64, 0x7d, 0x42,
...
var file_as_external_api_alarm_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_as_external_api_alarm_proto_depIdxs = []int32{
	...
	1, // 3: api.AlarmService.Create:input_type -> api.CreateAlarmRequest
	2, // 4: api.AlarmService.Get:input_type -> api.GetAlarmRequest
	5, // 5: api.AlarmService.Update:input_type -> api.UpdateAlarmRequest
	4, // 6: api.AlarmService.Delete:input_type -> api.DeleteAlarmRequest
	6, // 7: api.AlarmService.Create:output_type -> google.protobuf.Empty
	3, // 8: api.AlarmService.Get:output_type -> api.GetAlarmResponse
	3, // 9: api.AlarmService.Update:output_type -> api.GetAlarmResponse
	6, // 10: api.AlarmService.Delete:output_type -> google.protobuf.Empty
