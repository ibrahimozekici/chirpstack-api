...
var file_as_external_api_alarm_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0xb4, 0x03, 0x0a, 0x0c, 0x41, 0x6c, 0x61, 0x72, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x50, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x17, 0x2e, 0x61,
	...
	0x2f, 0x7b, 0x61, 0x6c, 0x61, 0x72, 0x6d, 0x5f, 0x69, 0x64, 0x7d, 0x3a, 0x01, 0x2a, 0x12, 0x58,
	...
	0x17, 0x2a, 0x15, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x6c, 0x61, 0x72, 0x6d, 0x2f, 0x7b, 0x61,
	0x6c, 0x61, 0x72, 0x6d, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x63, 0x0a, 0x21, 0x69, 0x6f, 0x2e, 0x63,
	...
	0x61, 0x63, 0x6b, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x76, 0x34, 0x2f, 0x61, 0x73,
...
var file_as_external_api_alarm_proto_depIdxs = []int32{
	...
	9,  // 10: api.AlarmService.Create:output_type -> google.protobuf.Empty
...
type AlarmServiceClient interface {
	...
	Create(ctx context.Context, in *CreateAlarmRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *alarmServiceClient) Create(ctx context.Context, in *CreateAlarmRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type AlarmServiceServer interface {
	// Create creates the alarm
	Create(context.Context, *CreateAlarmRequest) (*empty.Empty, error)
	// Get return the alarm
...
func (*UnimplementedAlarmServiceServer) Create(context.Context, *CreateAlarmRequest) (*empty.Empty, error) {
