...
var (
	filter_DeviceService_ListTemperatureData_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func RegisterDeviceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DeviceServiceServer) error {
	...
	mux.Handle("GET", pattern_DeviceService_ListTemperatureData_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_DeviceService_TemperatureDataList_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_DeviceService_ListTemperatureData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "devices"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_DeviceService_TemperatureDataList_0 = runtime.ForwardResponseMessage
)
