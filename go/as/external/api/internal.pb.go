...
type LandingZone struct {
	...
	OrganizationId int64            `protobuf:"varint,3,opt,name=organization_id,proto3" json:"organization_id,omitempty"`
...
func (x *LandingZone) GetOrganizationId() int64 {
	if x != nil {
		return x.OrganizationId
	}
	return 0
...
var file_as_external_api_internal_proto_rawDesc = []byte{
	...
	0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x39, 0x0a, 0x0f,
	...
	0x52, 0x05, 0x7a, 0x6f, 0x6e, 0x65, 0x73, 0x22, 0x9d, 0x01, 0x0a, 0x0b, 0x4c, 0x61, 0x6e, 0x64,
	...
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x12, 0x2c, 0x0a, 0x07, 0x64, 0x65, 0x76,
...
var file_as_external_api_internal_proto_depIdxs = []int32{
	...
	11, // 6: api.LandingZoneList.zones:type_name -> api.LandingZone
	15, // 7: api.LandingZone.devices:type_name -> api.LandingDevice
	13, // 8: api.LandingOrganizationList.organizations:type_name -> api.LandingOrganization
	14, // 9: api.LandingOrganization.applications:type_name -> api.LandingApplication
	15, // 10: api.LandingApplication.devices:type_name -> api.LandingDevice
	16, // 11: api.LandingDevice.alerts:type_name -> api.LandingAlarm
	32, // 12: api.ProfileResponse.user:type_name -> api.User
	6,  // 13: api.ProfileResponse.organizations:type_name -> api.OrganizationLink
	20, // 14: api.GlobalSearchResponse.result:type_name -> api.GlobalSearchResult
	22, // 15: api.SettingsResponse.branding:type_name -> api.Branding
	23, // 16: api.SettingsResponse.openid_connect:type_name -> api.OpenIDConnect
	30, // 17: api.GetDevicesSummaryResponse.dr_count:type_name -> api.GetDevicesSummaryResponse.DrCountEntry
	7,  // 18: api.InternalService.Login:input_type -> api.LoginRequest
	33, // 19: api.InternalService.Profile:input_type -> google.protobuf.Empty
	18, // 20: api.InternalService.GlobalSearch:input_type -> api.GlobalSearchRequest
	1,  // 21: api.InternalService.CreateAPIKey:input_type -> api.CreateAPIKeyRequest
	3,  // 22: api.InternalService.DeleteAPIKey:input_type -> api.DeleteAPIKeyRequest
	4,  // 23: api.InternalService.ListAPIKeys:input_type -> api.ListAPIKeysRequest
	33, // 24: api.InternalService.Settings:input_type -> google.protobuf.Empty
	24, // 25: api.InternalService.OpenIDConnectLogin:input_type -> api.OpenIDConnectLoginRequest
	26, // 26: api.InternalService.GetDevicesSummary:input_type -> api.GetDevicesSummaryRequest
	28, // 27: api.InternalService.GetGatewaysSummary:input_type -> api.GetGatewaysSummaryRequest
	8,  // 28: api.InternalService.Login:output_type -> api.LoginResponse
	17, // 29: api.InternalService.Profile:output_type -> api.ProfileResponse
	19, // 30: api.InternalService.GlobalSearch:output_type -> api.GlobalSearchResponse
	2,  // 31: api.InternalService.CreateAPIKey:output_type -> api.CreateAPIKeyResponse
	33, // 32: api.InternalService.DeleteAPIKey:output_type -> google.protobuf.Empty
	5,  // 33: api.InternalService.ListAPIKeys:output_type -> api.ListAPIKeysResponse
	21, // 34: api.InternalService.Settings:output_type -> api.SettingsResponse
	25, // 35: api.InternalService.OpenIDConnectLogin:output_type -> api.OpenIDConnectLoginResponse
	27, // 36: api.InternalService.GetDevicesSummary:output_type -> api.GetDevicesSummaryResponse
	29, // 37: api.InternalService.GetGatewaysSummary:output_type -> api.GetGatewaysSummaryResponse
